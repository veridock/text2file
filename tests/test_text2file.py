...
class TestText2File(TestCase):
    ...
    def test_generate_text_file(self):
        ...
        self.assertEqual(output_path.read_text(encoding="utf-8").strip(), self.test_content)
    ...
    def test_generate_markdown_file(self):
        ...
        self.assertEqual(output_path.read_text(encoding="utf-8").strip(), markdown_content)
